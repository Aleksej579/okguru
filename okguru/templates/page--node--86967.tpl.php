...
<div class="wrap-menu in_dev">
	...
	<!-- razdel ----------------------------------------------------- -->
    <div id="razdel" class="clearfix"></div>
    <!-- razdel ----------------------------------------------------- -->
    
	
	<div id="main-wrapper" class="clearfix in_dev"><div id="main" class="clearfix">
	...
	<div class="wrap-region-text">
		<?php print render($page['text']); ?>
	</div>

	<?php if ($page['triptych_first'] || $page['triptych_middle'] || $page['triptych_last']): ?>
		<div id="triptych-wrapper" class="in_dev">
	<div class='px1200'>
	<div id="triptych" class="clearfix">
		...
		</div></div></div> <!-- /#triptych, /#triptych-wrapper -->
	<?php endif; ?>
